...
set_property PACKAGE_PIN U9 [get_ports cipher_en]					
	set_property IOSTANDARD LVCMOS33 [get_ports cipher_en]
##Bank = 34, Pin name = IO_25_34,							Sch name = SW1
set_property PACKAGE_PIN U8 [get_ports enc_decN]					
	set_property IOSTANDARD LVCMOS33 [get_ports enc_decN]
