...
set_property PACKAGE_PIN R5 [get_ports {din[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {din[4]}]
##Bank = 34, Pin name = IO_L20P_T3_34,						Sch name = SW5
set_property PACKAGE_PIN V7 [get_ports {din[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {din[5]}]
##Bank = 34, Pin name = IO_L20N_T3_34,						Sch name = SW6
set_property PACKAGE_PIN V6 [get_ports {din[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {din[6]}]
##Bank = 34, Pin name = IO_L10P_T1_34,						Sch name = SW7
set_property PACKAGE_PIN V5 [get_ports {din[7]}]					
...
set_property PACKAGE_PIN P4 [get_ports ctrl]					
